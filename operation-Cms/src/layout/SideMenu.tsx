  ...
  return (
    <Sider trigger={null} collapsible collapsed={collapsed}>
      <div style={{display: 'flex', height: '100%', flexDirection: 'column'}}>
        <div className="logo">{ !collapsed ? <><img style={{ width: '32px',height: '32px',objectFit: 'contain',marginRight: '13px' }} src="./../side.svg" alt=""/>运营管理系统</> : <img style={{ width: '32px',height: '32px',objectFit: 'contain' }} src="./../side.svg" alt=""/> }</div>
